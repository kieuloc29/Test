...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`梁Admin Bot梁\n
👀 Tên: Nguyễn Hữu Kiều Lộc ( Editor )
❎ Tuổi: 15
👤 Giới tính: Nam
💫 Chiều cao cân nặng: Đéo Nhớ =))
💘 Mối quan hệ: Độc thân
🌎 Quê quán: Đông Anh ( Hà Nội - 29 )
👫 Gu: Xem Làm Gì Tính Tán Tui Hả =))
🌸 Tính cách: Chả biết nữa =))
🌀 Sở thích: Chơi game, Làm chuyện xàm blabla, ăn, ngủ
💻Contact💻
☎ SĐT&Zalo:039.900.6036
